  ...
  return (
    <div className='form'>
      <form onSubmit={(e => handleSubmit(e))}>
        ...
        <input className='inputStyle' name='name' type='text' value={formData.name} placeholder='Name' required onChange={(e) => handleChange(e)} />
        <input className='inputStyle' name='birthdate' type='date' value={formData.birthdate} placeholder='Birthdate' required onChange={(e) => handleChange(e)} />
